...
@Data // toString, hashCode, equals, getters/setters... (if you don't have Lombok,
...
public class ApiError {
    ...
    public ApiError(HttpStatus status, Throwable ex) {
        ...
        this(status); // this will call the above constructor so we can piggy-back off of its
                      // functionality
